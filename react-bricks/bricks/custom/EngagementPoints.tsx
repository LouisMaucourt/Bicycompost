...
const EngagementPoints: types.Brick<EngagementPointsProps> = ({ title, image, imageCardOne, titleCardONe, descriptionCardONe, imageCardTwo, titleCardTwo, descriptionCardTwo, imageCardThree, titleCardThree, descriptionCardThree, imageCardFour, titleCardFour, descriptionCardFour }) => {
    return (
        <section style={{}} className='background-green  '>
            <div style={{ flexDirection: "row", gap: "70px", alignItems: "baseline", justifyContent: "space-between" }} className='container-content flexx2'>
                <div>
                    <Text
                        propName="title"
                        value={title}
                ...
                <div style={{ gap: "20px", alignItems: "baseline", width: "50%" }} className='flex-between'>
                    <div style={{ width: "100%" }} >
                        <div className='card-item-green-800 flex-row flex-right' style={{ justifyContent: "flex-start", height: '100px', padding: "15px" }}>
                            <Image
                    ...
                    <div style={{ width: "100%" }} >
                        <div className='card-item-green-800 flex-row' style={{ justifyContent: "flex-start", height: '100px', padding: "15px" }}>
                            <Image
