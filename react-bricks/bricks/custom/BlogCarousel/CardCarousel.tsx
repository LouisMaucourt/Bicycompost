...
interface BlogCarouselProps extends LayoutProps {
  slidesToShow: string;
...
const BlogCarouselBrick: types.Brick<BlogCarouselProps> = ({
  backgroundColor,
  borderTop,
  borderBottom,
  paddingTop,
...
BlogCarouselBrick.schema = {
  name: 'BlogCarousel',
  label: 'Blog Carousel',
  repeaterItems: [
    {
      name: 'images',
      itemType: blockNames.BlogCarouselItem,
      itemLabel: 'Blog Post',
      min: 1,
      max: 5,
    },
...
export default BlogCarouselBrick;
